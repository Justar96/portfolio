...
;(() => {
  ...
  function H(a, b) {
    ...
    c && ((this.a = c[1]), (this.f = Number.parseInt(c[2], 10)))
  }
  function fa(a) {
  ...
  function ga(a) {
    ...
    a &&
      ...
      (d = a.match(/([1-9]00|normal|bold)/i)) &&
        d[1] &&
        (/bold/i.test(d[1]) ? (b = 7) : /[1-9]00/.test(d[1]) && (b = Number.parseInt(d[1].substr(0, 1), 10))))
    return c + b
  }
  function ha(a, b) {
    this.c = a
  ...
  function U() {
    if (null === T) {
      ...
      T =
        !!a &&
        (536 > Number.parseInt(a[1], 10) || (536 === Number.parseInt(a[1], 10) && 11 >= Number.parseInt(a[2], 10)))
    }
    return T
  }
  ...
  sa.prototype.load = function (a) {
    ...
    if (d) {
      var f = this.c.m
      B(this.c, ta(this, d, e), (e) => {
        e ? a([]) : ((f["__MonotypeConfiguration__" + d] = () => this.a), b())
  ...
  Ia.prototype.load = function (a) {
    ...
    b
      ? (c.__webfontfontdeckmodule__ || (c.__webfontfontdeckmodule__ = {}),
        (c.__webfontfontdeckmodule__[b] = (b, c) => {
          for (var g = 0, k = c.fonts.length; g < k; ++g) {
            var h = c.fonts[g]
            this.a.push(new H(h.name, ga("font-weight:" + h.weight + ";font-style:" + h.style)))
          }
          a(this.a)
        }),
  ...
  var Y = new pa(window)
  Y.a.c.custom = (a, b) => new ua(b, a)
  Y.a.c.fontdeck = (a, b) => new Ia(b, a)
  Y.a.c.monotype = (a, b) => new sa(b, a)
  Y.a.c.typekit = (a, b) => new Ha(b, a)
  Y.a.c.google = (a, b) => new Fa(b, a)
